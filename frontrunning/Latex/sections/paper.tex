...
Transaction chaining -> resolve conflicts -> topological order/sort (also consider total order) -> cf UTXOs

FIFO -> consensus on FI -> possible in theory
-> could be solved with TTP -> censorship still possible (completeness issue)

FI_O -> FIRO -> deterministic random order -> manipulatable (malleability in the collection and your own items in the collection and maybe and other items in the collection) -> CTOR 
