...
\subsection{Historical Context / Classic front-running}
...
% talk about double-spend one kind of front-running (relationship between front-running vs double spend) rushing actors. 
...
%
%\begin{itemize}
%\item{\textbf{Their own mined blocks}: The can only front-run transactions within the block they mine. This could be done by reordering the transactions within the blocks.}
...
\item{\textbf{Submarine Commitments}: describe. General solution similar to commit and reveal. This is to solve the participatory factor of the commit and reveal solution.}
