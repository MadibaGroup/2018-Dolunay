...
\begin{figure}[t]
\floatbox[{\capbeside\thisfloatsetup{capbesideposition={left,bottom},capbesidewidth=0.3\linewidth}}]{figure}[\FBwidth]
...
\begin{figure}[t]
\floatbox[{\capbeside\thisfloatsetup{capbesideposition={left,top},capbesidewidth=0.5\linewidth}}]{figure}[\FBwidth]
...
\footnotetext{Graph was made using \url{Blockseer.com}}
...
%A recent attempt to build confidential transactions for DApps, is AZTEC protocol~\cite{aztec2018}. Similar to ZCash ~\cite{hopwood2016zcash}, it uses the concept of encrypted ‘notes’ and join-split transactions. ZCash uses two distinct types of addresses, transparent and shielded addresses, where in AZTEC, user transfers her ERC20 tokens into encrypted notes. Users can transfer these notes by destroying the unspent notes and creating new notes for the new owners, where the sum of the old notes should be equal to the sum of the new notes. 
