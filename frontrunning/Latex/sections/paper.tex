...
% Jeremy: Will work on this very last, once I know what the paper is actually about :)
...
% Jeremy: I don't real;y understand the below so dropping if no one protests. 
%The two significant factors which cause the front-running practice to happen within the financial markets are (i) imperfect competition and (ii) liquidity uncertainty~\cite{liang2005distressed}. 
...
%\textblue{Equate front-running to a rushing adversary in the crypto literature and cite the fact that UC models of blockchains capture front-running attacks: cite Bitcoin Backbone paper and Hawk paper in particular.} 
...
\paragraph{Miners.} \label{minersfrontrunning}
