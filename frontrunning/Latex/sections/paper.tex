...
The first category of DApp in Table~\ref{tab:top25DApps} is exchanges. 
...
The second category of DApp in Table~\ref{tab:top25DApps} is crypto-collectables. 
...
The third category of DApp in Table~\ref{tab:top25DApps} is gambling services.  
...
The final category of DApp in Table~\ref{tab:top25DApps} is name services.  
