...
Front-running was first observed on the Chicago Board Options Exchange (\textit{CBoE})~\cite{markham1988front}, and was defined by Securities Exchange Commission \textit{(SEC)} in 1977 as:
\begin{quote}
