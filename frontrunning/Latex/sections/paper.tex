...
Frontrunning was first appeared on the Chicago Board Options Exchange (CBoE) ~\cite{markham1988front}, and was identified by \textit{Securities Exchange Commission} in 1977 as the following:
\begin{quote}
...
On the years after there were ongoing discussions between self-regulatory exchanges (\eg CBoE) and SEC to regulate, detect and define laws and regulations to deal with frontrunning~\cite{markham1988front}, with \textit{SEC} stating: 
\begin{quote}
