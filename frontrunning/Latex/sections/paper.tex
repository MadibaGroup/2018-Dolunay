...
\section{Cases of Front-running in ICOs}  %TODO Shayan: based on how we start the previous section (Cases of Front-running in DApps), rewrite the first paragraph of this section (just for coherency and unity) + try to have seperate subsection for each part to make it more compelling and interesting.
\label{sec:ICOsfrontrunning}
