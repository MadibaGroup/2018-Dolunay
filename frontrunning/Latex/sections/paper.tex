...
\textbf{CASE STUDY} should be used in here, also in abstract, also at the end of intro section 
...
%TODO: this might not considered as the definition of frontrunning, but it is common to use frontrunning for this so we do the same. 
...
\subsection{Domain Name Front-running} \hfill\\    %Following section talks about front-running in namespaces but limited to Ghazal. Will talk about NameCoin in the section of mitigations (commit & reveal method)
