...
//*******************  maxheap_delete () ***************************//
    ...
    {
        if (SellList.length == 0) { throw; }                             //the delete function throws exception if the heap is empty  //"!SYNTAX!"
        if (SellList.length == 1) {                                      // if the heap has only one items
            var result = OrderStruct(_sender, _price ,_volume);          //"!SYNTAX!"
            result = SellList[0];
...
//*******************  minheap_insert () ***************************//
    ...
    {
        var neworder = OrderStruct(_sender, _price ,_volume); //"!SYNTAX!"
        SellList.push(neworder);
...
//*******************  minheap_delete () ***************************//
    ...
    {
        if (BuyList.length == 0) { throw; }                      //the delete function throws exception if the heap is empty  "!SYNTAX!"
