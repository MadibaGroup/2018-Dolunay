...
//**********************************************//
    function delete ()
    {
     if (items.length == 0) { throws exception;} //the delete function throws exception if the heap is empty //!!!!!!!!!!check the solidity syntax!!!!!!!!!!//
     if (items.length == 1){ // if the heap has only one items
        return items.remove(0); //the only element of the heap is removed and returned  //!!!!!!!!!!check the solidity syntax!!!!!!!!!!//
     }
    ...
    remove items[length] -1 //!!!!!!!!!!check the solidity syntax!!!!!!!!!!//
